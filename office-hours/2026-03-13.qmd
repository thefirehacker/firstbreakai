...
First Break AI follows this pattern: the [Roadmap](../roadmap.qmd) is the learning path, office hours are the touchpoints, [Discord](https://discord.gg/QZuBvfcj) is the async channel, and each step builds on the previous one.
