...
**Guide:** [Run Qwen3 0.6B in pure C](blog/qwen3-run-locally.qmd) — inference from first principles (tokenization, chat templates, attention, KV cache).
:::
:::
...
**Guide:** [Run Qwen3 0.6B in pure C](blog/qwen3-run-locally.qmd) — inference from first principles.
:::
