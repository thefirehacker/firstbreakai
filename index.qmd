...
The cohort is archived and fully async. Start with FBA Lab — hands-on AI system work, no GPU or setup required. Join Discord for community support.

[Start with FBA Lab](https://bubblnet.com/){.cta-button}

[Join Discord](https://discord.gg/hRPese4H3F){.cta-button}

**Focused sessions** run when there is real work to review: demos, project submissions, debugging, training runs, or walkthrough requests. Announcements on Discord.
...
<div class="faq">
  ...
  <details class="faq-item">
    ...
    <div class="faq-body">
      ...
      <ul>
        <li><strong>Cohort-based.</strong> Office hours run when there is real work to review — demos, project submissions, debugging, and walkthroughs. Karpathy's lectures are one-way; this is two-way.</li>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Plan for 5 to 8 hours a week to comfortably work through the lessons and roadmap. The async materials are self-paced — there is no required weekly commitment. Cohort 01 ran 1 May 2026 to 30 June 2026 and is now archived. Everything stays online, so you can move at your own pace."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Everything is asynchronous. Cohort 01 is archived — all lessons, recaps, and transcripts stay online and are searchable. The Discord stays active and materials are available to anyone. Focused sessions run when there is real work to review."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "First Break AI is openly inspired by Andrej Karpathy's Let's reproduce GPT-2 (124M) and llm.c — the from-scratch, no-magic, run-it-in-pure-C approach to teaching how LLMs actually work. Those are still the gold standard for a single lecturer building a model in front of you, and they are the philosophical foundation under this entire cohort. The pure-C Qwen3 demo in Lesson 1 (code by William Song) is the direct intellectual descendant of llm.c. We sit on top of that work and extend it in four directions. First, cohort-based: office hours run when there is real work to review — demos, project submissions, debugging, and walkthroughs. Second, a 2026-current stack: Qwen3 instead of GPT-2, transformers v5, vLLM, AI agents, agentic AI tooling, the HuggingFace supply-chain lens. Third, shipping a product is in scope — Step 5 of the roadmap is building a deployed AI product, not just training a model in a notebook. Fourth, completely agentic by design: First Break AI is the first cohort built around AI agents from day one. AI agents answer questions, validate homework, track progress, and guide learners through the roadmap — all via the Model Context Protocol (MCP). The agentic infrastructure is powered by FetchLens.ai, which provides the MCP server backbone, the AI agent widget on every page, and authenticated progress tracking. You don't just learn about AI agents — you use them throughout the cohort. fast.ai and HuggingFace's free course are excellent complementary reads, and the roadmap links to them where they fit."
      }
    },
    {
      "@type": "Question",
