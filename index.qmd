...
::: {.hero-section}
![](public/images/Fort-Journey-01.png){.hero-image}

**First Break AI** — your first break in AI.
Free, open cohort to upskill in training, inference, and AI product building, and showcase what you build.
:::
...
(function() {
  ...
  // IST is UTC+5:30; Friday 21:00 IST = 15:30 UTC
  var fri = new Date();
